										...
										children: [
											Wrap(
												...
												children: _communities
													.map((item) => _CommunityItemTile(data: item))
													.toList(),
											),
											Align(
								...
								..._recentChats
									.map(
										(chat) => Padding(
											...
											child: _RecentChatTile(data: chat),
										),
									)
							],
						),
...
class _CommunityItemTile extends StatelessWidget {
	const _CommunityItemTile({required this.data});
...
class _RecentChatTile extends StatelessWidget {
	const _RecentChatTile({required this.data});
